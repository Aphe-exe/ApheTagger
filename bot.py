...
async def start(event):
  await event.reply("**LoungeTagger Bot**, Grup veya kanaldaki neredeyse tüm üyelerden bahsedebilirim ★\nDaha fazla bilgi için **/help**'i tıklayın.",
                    buttons=(
                      [Button.url('🌟 Beni Bir Gruba Ekle', 'https://t.me/Aphetaggerbot?startgroup=a'),
                      Button.url('📣 Support', 'https://t.me/ApheTaggerSup'),
                      Button.url('🚀 Sahibim', 'https://t.me/ApheDev')]
                    ),
                    link_preview=False
                   )
...
print(">> Bot çalıyor merak etme 🚀 @ApheTaggerSup bilgi alabilirsin <<")
